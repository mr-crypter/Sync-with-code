...
You can view the live preview of the project [TO BE UPDATED].
...
2. **Clone the repository:**
    ```bash
    git clone https://github.com/mr-crypter/Sync-with-code.git
    ```
3. **Set .env file:**
   Inside the client and server directories create a file to `.env` and set the following environment variables:
